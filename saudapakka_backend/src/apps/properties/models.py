...
class Property(models.Model):
    ...
    # --- CRITICAL FIX: Add this method to prevent Database Crashes ---
    def save(self, *args, **kwargs):
        # 1. Fix: Catch the String "[]" (Which Django Admin sends)
        if self.embedding == '[]':
            self.embedding = None
            
        # 2. Fix: Catch the Empty List [] (Which Python code might send)
