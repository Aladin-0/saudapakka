            ...
            {step === "EMAIL" ? (
              ...
              <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-300">
                 <div className="space-y-2">
                    ...
                    <div className="relative group">
                        <KeyRound className="absolute left-4 top-3.5 h-5 w-5 text-gray-400 group-focus-within:text-accent-green transition-colors" />
                        <Input 
                            placeholder="• • • • • •" 
                            className="pl-11 h-12 rounded-xl border-gray-200 bg-gray-50/50 focus:bg-white focus:border-accent-green focus:ring-4 focus:ring-accent-green/10 transition-all tracking-[0.5em] text-lg font-semibold text-gray-800"
                            value={otp} 
