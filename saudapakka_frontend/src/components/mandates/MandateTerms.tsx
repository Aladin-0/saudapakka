    ...
    return (
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <div className="h-64 overflow-y-auto space-y-4 text-gray-600 text-sm pr-2 custom-scrollbar">
                <p><strong>1. Parties Involved:</strong> This mandate agreement is entered into between the Initiator (Seller/Real Estate Agent) and the Recipient (Real Estate Agent/Seller/Platform), hereinafter referred to as the "Parties".</p>

                <p><strong>2. Scope of Mandate:</strong> The Owner grants the Real Estate Agent the right to market and negotiate the sale/lease of the Property listed attached to this mandate. This right is subject to the exclusivity terms defined in the mandate details.</p>
                ...
                <p><strong>4. Commission:</strong> The Real Estate Agent is entitled to a commission as specified in this mandate upon the successful conclusion of a sale, lease, or binding agreement resulting from their introduction or efforts.</p>

                <p><strong>5. Exclusivity:</strong> If "Exclusive" is selected, the Owner agrees not to appoint other real estate agents for this Property during the Term. If "Non-Exclusive", the Owner retains the right to market the property themselves or through other real estate agents.</p>
